...
Revision ID: d826e710d033
Revises: 
Create Date: 2026-05-20 23:04:42.828423
...
def upgrade():
    ...
    sa.Column('daily_ai_calls', sa.Integer(), nullable=True),
    sa.Column('last_ai_call_date', sa.Date(), nullable=True),
